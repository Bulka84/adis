...
const cases = [
  ...
  },
  {
    ...
    solution: "Поэтапное внедрение ПК «АДИС» в Перми и 18 городах края с подготовкой диспетчера персонала и адаптацией под существующую технологию.",
    results: ["322 АРМ в 19 населённых пунктах", "Подготовка диспетчера всех диспетчеров за 2 смены", "Исключение дублирующих выездов"],
  },
  {
