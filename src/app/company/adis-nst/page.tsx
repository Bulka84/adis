...
import { ArrowLeft, Briefcase, Database, Settings2, Wrench } from "lucide-react";

export const metadata: Metadata = {
  title: "ООО «АДИС-НСТ»",
  description:
    "Описание деятельности ООО «АДИС-Новые Системные Технологии» в рамках внедрения и сопровождения ПК «АДИС».",
};
...
const highlights = [
  {
    ...
    title: "Основная роль",
    text:
      "ООО «АДИС-Новые Системные Технологии» занимается внедрением и обслуживанием программного продукта ПК «АДИС».",
  },
  {
    icon: Settings2,
    title: "Эксплуатация и сопровождение",
    text:
      "Компания обеспечивает подготовку систем к эксплуатации, адаптацию, настройку и сопровождение решений у заказчиков.",
  },
  {
    icon: Database,
    title: "Работа с данными",
    text:
      "Компания выполняет администрирование баз данных, их модификацию, тестирование и поддержку в ходе эксплуатации.",
  },
];
      ...
      <section className="hero-dark min-h-screen flex items-center py-32 lg:py-40">
        ...
        <div className="relative z-[2] max-w-[1200px] mx-auto px-6">
          ...
          <p className="text-xl text-white/60 max-w-4xl leading-relaxed">
            Компания занимается внедрением и обслуживанием программного продукта
            Программный комплекс автоматизации диспетчерской службы станции скорой
            медицинской помощи ПК &laquo;АДИС&raquo;, зарегистрированного в едином
            реестре российских программ для электронных вычислительных машин и
            баз данных за регистрационным номером 1591.
          </p>
        </div>
      </section>
