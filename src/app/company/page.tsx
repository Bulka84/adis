...
const companies = [
  {
    ...
    text:
      "Компания занимается внедрением и обслуживанием программного продукта ПК «АДИС», а также оказывает услуги по сопровождению, адаптации и подготовке систем к эксплуатации.",
  },
  {
    ...
    href: "/company/nst",
    text:
      "Компания занимается разработкой, внедрением и обслуживанием собственного программного продукта ПК «АДИС», а также разработкой средств взаимодействия с другими программно-аппаратными средствами.",
  },
];
