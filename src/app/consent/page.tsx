...
export const metadata: Metadata = {
  ...
  description:
    "Согласие посетителя сайта на обработку персональных данных ООО Фирма «Новые Системные Технологии».",
};
...
const sections = [
  {
    ...
    content: [
      "Настоящим, оставляя свои данные на сайте adis-nst.ru, посетитель сайта подтверждает своё согласие на обработку персональных данных ООО Фирма «Новые Системные Технологии».",
      ...
      <section className="hero-dark min-h-screen flex items-center py-32 lg:py-40">
        ...
        <div className="relative z-[2] max-w-[1200px] mx-auto px-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <FileCheck2 size={20} className="text-white/40" />
          </div>
