...
const sections = [
  ...
  },
  {
    ...
    content: [
      "Посетитель сайта вправе отозвать настоящее согласие путём направления письменного уведомления оператору персональных данных по адресу электронной почты nst@adis-nst.ru или по телефону +7 (495) 739-48-07.",
