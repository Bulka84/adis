...
export const metadata: Metadata = {
  title: "Услуги и цены",
  description: "Услуги по внедрению и сопровождению ПК «АДИС»: анализ, инсталляция, настройка, подготовка диспетчера, техническое сопровождение.",
};
...
const services = [
  ...
  { title: "Подготовка диспетчера", description: "Подготовка медицинского персонала к работе с каждым типом автоматизированного рабочего места в оперативном режиме.", icon: GraduationCap },
  { title: "Подготовка специалиста", description: "Подготовка технического персонала СМП к обслуживанию и техническому сопровождению программного комплекса.", icon: HeadphonesIcon },
  ...
  return (
    <>
      <section className="bg-[#e8ebf2] min-h-screen flex items-center py-32 lg:py-40">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 max-w-3xl">
            {[
              ...
              { icon: GraduationCap, label: "Подготовка диспетчера" },
              ...
              <div key={item.label} className="bg-[#e8f0fe] border border-[#b0ccf5] rounded-2xl p-4 flex items-center gap-3">
        ...
        <HeroScrollIndicator targetId="services-list" variant="light" />
      </section>
      ...
      <section className="py-24">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="bg-[#e8f0fe] border border-[#b0ccf5] rounded-3xl py-16 px-12 text-center">
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-extrabold text-gray-900 leading-[1.2] mb-4">Стоимость</h2>
            <p className="text-lg text-gray-500 max-w-[500px] mx-auto mb-8 leading-relaxed">
              Стоимость ПК &laquo;АДИС&raquo; формируется исходя из необходимого
              количества лицензий для серверов и рабочих станций.
            </p>
            <Link
              href="/contacts#form"
              className="btn-gradient inline-flex items-center gap-2 px-8 py-4 font-semibold rounded-xl text-[15px]"
            >
