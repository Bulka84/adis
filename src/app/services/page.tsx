...
const services = [
  ...
  { title: "Подготовка диспетчера медперсонала", description: "Подготовка медицинского персонала к работе с каждым типом автоматизированного рабочего места в оперативном режиме.", icon: GraduationCap },
  { title: "Подготовка диспетчера техперсонала", description: "Подготовка технического персонала СМП к обслуживанию и техническому сопровождению программного комплекса.", icon: HeadphonesIcon },
        ...
        <div className="relative z-[2] max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 max-w-3xl">
            {[
              ...
              { icon: GraduationCap, label: "Подготовка диспетчера персонала" },
