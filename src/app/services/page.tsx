...
const services = [
  ...
  { title: "Подготовка диспетчера", description: "Подготовка технического персонала СМП к обслуживанию и техническому сопровождению программного комплекса.", icon: HeadphonesIcon },
