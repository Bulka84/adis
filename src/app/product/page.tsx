...
const workstations = [
  ...
  { name: "АРМ статистической и административной службы регионального уровня", description: "СМП регионального уровня показателей оперативности как по региону в целом, так и по отдельным районным станциям и отделениям СМП.", icon: BarChart3 },
];
